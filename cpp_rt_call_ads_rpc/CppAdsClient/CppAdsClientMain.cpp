...
class CCppAdsClientCtrl : public ITcOCFCtrlImpl<CCppAdsClientCtrl, CCppAdsClientClassFactory>
{
public:
	CCppAdsClientCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("CppAdsClient: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CCppAdsClientCtrl>;
